...
public enum ErrorCode {
    DUPLICATED_USERNAME("중복된 사용자 입니다"),
    MANY_BUILDING("건물은 1에서 3까지 등록 가능합니다."),
    MANY_FLOOR("층은 1에서 5까지 등록 가능합니다."),
    NOT_GSM_EMAIL("학교 계정으로만 회원가입할 수 있습니다."),
    NOT_MATCH_INFORMATION("사용자를 찾을 수 없습니다."),
    FILE_UPLOAD_ERROR("파일 업로드에 실패했습니다."),
    NOT_MATCH_POST("게시물을 찾을 수 없습니다."),
    INVALID_SESSION("세션이 유효하지 않습니다."),
    INVALID_AUTHORIZED("권한이 없습니다."),
    INVALID_REQUEST("잘못된 요청입니다."),
    INTERNAL_SERVER_ERROR("서버 오류입니다."),
    ALREADY_USER_ID("중복된 아이디입니다."),
    ALREADY_USER_USERNAME("중복된 닉네임입니다."),
