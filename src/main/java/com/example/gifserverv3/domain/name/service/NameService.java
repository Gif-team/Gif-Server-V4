...
public class NameService {
    ...
    static {
        ...
        EMAIL_TO_NAME_MAP.put("s24008", "NULL");
        EMAIL_TO_NAME_MAP.put("s24009", "이서준");
        EMAIL_TO_NAME_MAP.put("s24010", "이서희");
        EMAIL_TO_NAME_MAP.put("s24011", "이세민");
        EMAIL_TO_NAME_MAP.put("s24012", "이영서");
        EMAIL_TO_NAME_MAP.put("s24013", "임한솔");
        EMAIL_TO_NAME_MAP.put("s24014", "전선우");
        EMAIL_TO_NAME_MAP.put("s24015", "정효주");
        EMAIL_TO_NAME_MAP.put("s24016", "주여진");
        EMAIL_TO_NAME_MAP.put("s24017", "하창혁");
        EMAIL_TO_NAME_MAP.put("s24018", "함성우");
        ...
        // 필요한 추가 매핑 데이터를 여기에 입력
    }

    // 이메일로부터 username을 생성하는 메소드
    public static String getUsernameFromEmail(String email) {
        // 이메일 ID 추출 (예: s24021@gsm.hs.kr -> s24021)
        String emailId = email.split("@")[0];

        // 매핑 데이터에 해당 ID가 있는지 확인
        return EMAIL_TO_NAME_MAP.getOrDefault(emailId, "Unknown User");
    }
}
